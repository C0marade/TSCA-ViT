...
class TSCA_Cross_Attention(nn.Module):
...
class TSCA_CrossAttentionBlock(nn.Module):
    def __init__(self, in_dim, key_dim, value_dim, height, width, head_count=1, token_mlp="mix"):
        super().__init__()
        self.norm1 = nn.LayerNorm(in_dim)
        self.H = height
        self.W = width
        self.attn = TSCA_Cross_Attention(key_dim, value_dim, height, width, head_count=head_count)
